/** https://github.com/datalog/datamatrix-svg under MIT license # datamatrix.js has no dependencies Copyright (c) 2020 Constantine */
'use strict';
function DATAMatrix(Q) {
    var M = [],
        ...
        toText = function(t, s) {
            var i, j, cc = 0,
                ...
                l = t.length,
                r = [s[0]], /* start switch */
                push = function(v) { /* pack 3 chars in 2 codes */
                    cw = 40 * cw + v; /* add code */
                    if (cc++ == 2) {
                        r.push(++cw >> 8), r.push(cw & 255), cc = cw = 0;
                    }
                };
            for (i = 0; i < l; i++) { /* last char in ASCII is shorter */
                if (0 == cc && i == l - 1) break;
        ...
        encodeMsg = function(text, rct) {
            ...
            var h, w, nc = 1,
                nr = 1,
                fw, fh, /* symbol size, regions, region size */
                i, j = -1,
                c, r, s, b = 1, /* compute symbol size */
            ...
            c = 0, /* column */
            r = 4, /* row */
            b = [ /* nominal byte layout */ 0, 0, -1, 0, -2, 0, 0, -1, -1, -1, -2, -1, -1, -2, -2, -2];
            /* diagonal steps */
            for (i = 0; i < l; r -= s, c += s) {
    ...
    return (function() {
        ...
        var abs = Math.abs,
            r, x, y, d, sx, sy, ns = 'http://www.w3.org/2000/svg',
            path = '',
            q = ('string' == typeof Q) ? {
                msg: Q
            } : Q || {},
